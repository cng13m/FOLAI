  ...
  return (
    <SectionShell id="demo" className="section-fade">
      ...
      <div className="mt-14 grid gap-6 xl:grid-cols-[1.08fr_0.92fr]">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950/55 p-5 shadow-glow">
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(125,211,252,0.13),transparent_35%)]" />
            <div className="relative rounded-[1.5rem] border border-white/10 bg-white/[0.03] p-4 sm:p-5">
              ...
              <div className="mt-6 space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div className="max-w-[85%] rounded-[1.35rem] rounded-tl-md border border-white/10 bg-white/[0.04] px-4 py-3 text-sm leading-7 text-slate-200/90">
                    Përshëndetje, dua një termin për pastrim fytyre të shtunën pas orës 17:00.
                  </div>
                </div>

                <div className="flex items-start justify-end gap-3">
                  <div className="max-w-[86%] rounded-[1.35rem] rounded-tr-md bg-gradient-to-r from-cyan-300 to-emerald-300 px-4 py-3 text-sm leading-7 text-slate-950">
                    Mund t’ju rezervoj në 17:30 ose 18:15. Cili orar ju përshtatet më shumë?
                  </div>
                  <div className="mt-1 flex h-10 w-10 items-center justify-center rounded-2xl bg-cyan-300/14 text-slate-950">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="max-w-[84%] rounded-[1.35rem] rounded-tl-md border border-white/10 bg-white/[0.04] px-4 py-3 text-sm leading-7 text-slate-200/90">
        ...
        <div className="space-y-6">
          ...
          <Reveal delay={0.2}>
            <div className="overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-white/[0.07] via-white/[0.03] to-cyan-300/[0.06] p-6 shadow-soft">
